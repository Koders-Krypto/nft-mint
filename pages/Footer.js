...
<div className="max-w-4xl mx-auto bg-slate-200 mt-20">
	...
	<footer className="p-2 bg-slate-200 rounded-lg md:px-10 md:py-0">
		...
		<hr className="my-20 sm:mx-auto border-gray-700 lg:my-8" />
		<span className="block text-sm text-gray-900 sm:text-center ">All Rights Reserved © 2022 - <a href="https://niftminter.com" target="_blank" className="hover:underline">NFT Minter</a>
    </span>
	</footer>
</div>
  )
